...
function M.parse(arg)
    ...
    cmd:option('-data', '/imagenet', 'Home of ImageNet dataset')
    ...
    cmd:option('-flattenParams',  false, 'use -flattenParams for DataParallelTable')
    cmd:option('-usenccl',  false, 'use -usenccl for DataParallelTable')
    cmd:text()
